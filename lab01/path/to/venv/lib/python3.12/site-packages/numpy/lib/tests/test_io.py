...
class TestSaveTxt:
    ...
    def test_unicode(self):
        ...
        with tempdir() as tmpdir:
            ...
            np.savetxt(os.path.join(tmpdir, 'testRuns'), a, fmt=['%s'],
                       encoding='UTF-8')
    ...
    def test_unicode_roundtrip(self):
        ...
        with tempdir() as tmpdir:
            for suffix in suffixes:
                np.savetxt(os.path.join(tmpdir, 'testRuns' + suffix), a,
                           fmt=['%s'], encoding='UTF-16-LE')
                b = np.loadtxt(os.path.join(tmpdir, 'testRuns' + suffix),
...
M   33  21.99
    ...
    def test_file_is_closed_on_error(self):
        # gh-13200
        with tempdir() as tmpdir:
            fpath = os.path.join(tmpdir, "testRuns")
